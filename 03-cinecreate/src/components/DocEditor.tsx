  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      <div className="flex items-center gap-3 px-6 py-3 bg-[var(--bg2)] border-b border-[var(--border)]">
        <input className="bg-transparent text-base font-bold text-[var(--text)] outline-none border-b border-transparent hover:border-[#333] focus:border-indigo-500 flex-1"
